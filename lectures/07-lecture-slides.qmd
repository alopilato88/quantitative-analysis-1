...
$$X_{\text{Per. Useful.}}=\beta_0 + \beta_1X_{\text{Perc. Ease Use}}+\epsilon$$
$$Y_{\text{Beh. Intet.}}=\beta_0+\beta_1X_{\text{Per. Ease Use}}+\beta_2X_{\text{Per. Useful.}}+\beta_3Z_{\text{Mod.}}+\epsilon$$
...
## A More Advanced Published Example 
