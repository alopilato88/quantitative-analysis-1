...
data_frame_1 <- data.frame(numeric = c(1, 3), character = c("a", "b"), 
                           logical = c(TRUE, FALSE), numeric_1 = c(2, 2))
...
data_frame_1$numeric[1]

## Subsetting your data frame

subset(data_frame_1, character == "b")
subset(data_frame_1, numeric_1 == 2)
subset(data_frame_1, numeric_1 == 2 & logical)
