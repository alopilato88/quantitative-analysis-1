...
| Date  | Topic                  | Readings                                                                                                              |
+:======+:=======================+:======================================================================================================================+
| 9/5   | Bivariate Measures of  | - RAGLM – Chapter 1: Statistical Control & Linear Models                                                              |
|       | Association &          |                                                                                                                       |
|       | Simple Regression      | - RAGLM – Chapter 2: The Simple Regression Model                                                                      |
|       |                        |                                                                                                                       |
|       |                        | - *DBEP – Chapter 4.6: Dependence, Covariane, & Correlation*                                                          |
|       |                        |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 9/12  | Measures of Partial    | - RAGLM – Chapter 3: Partial Relationship & the Multiple Regression Model                                             |
|       | Association &          |                                                                                                                       |
|       | Multiple Regression    | - [R for Data Science – Chapter 4: Data Transformation](https://r4ds.hadley.nz/data-transform)                        |
|       |                        |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 9/19  | Statistical Inference  | - RAGLM – Chapter 4: Statistical Inference in Regression                                                              |
|       | for Regression         |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 9/29  | Categorical Predictors | - RAGLM – Chapter 5: Extending Regression Analysis & Principles                                                       |
|       | & Model Building       |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 10/17 | Nonlinear Effects,     | - RAGLM – Chapter 12.1 & 12.2: Nonlinear Relationships                                                                |
|       | Interactions, &        |                                                                                                                       |
|       | Model Building         | - RAGLM – Chapter 13: Linear Interaction                                                                              |
|       |                        |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 11/3  | General Linear Model:  | - RAGLM – Chapter 10: More on Multicategorical Regressors                                                             |
|       | ANOVA, ANCOVA, & MR    |                                                                                                                       |
|       | and Diagnostics        | - RAGLM – Chapter 11: Mutliple Tests                                                                                  |
|       |                        |                                                                                                                       |
|       | **Immersion Day**      | - RAGLM – Chapter 16: Detecting & Managing Irregularities                                                             |
|       |                        |                                                                                                                       |
|       |                        | - *Cohen (1968). Multiple regression as a general data-analytic system.*                                              |
|       |                        |                                                                                                                       |
|       |                        | - *Wendorf (2004). Primer on multiple regression coding*                                                              |
|       |                        |                                                                                                                       |
|       |                        | - *Chatterjee & Yilmaz (1992). A review of regression diagnostics for behavioral research.*                           |
|       |                        |                                                                                                                       |
|       |                        | - [Data Analysis in R – Chapter 7](https://bookdown.org/steve_midway/DAR/understanding-anova-in-r.html)               |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 11/7  | Prediction             | - RAGLM – Chapter 7: Regression for Prediction                                                                        |
|       |                        |                                                                                                                       |
|       |                        | - DBEP – Chapter 13: A Framework for Prediction                                                                       |
|       |                        |                                                                                                                       |
|       |                        | - DBEP – Chapter 14: Model Building for Prediction                                                                    |
|       |                        |                                                                                                                       |
|       |                        | - Yarkoni & Westfall (2017). Choosing prediction over explanation in psychology: Lessons from machine learning.       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 11/14 | Introduction to        | - DBEP – Chapter 19: A Framework for Causal Analysis                                                                  |
|       | Causation              |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 11/28 | Experimental Design    | - DBEP – Chapter 20: Designing & Analyzing Experiments                                                                |
|       | & Analysis             |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 12/5  | Causal Inference with  | - DBEP – Chapter 21: Regression & Matching with Observational Data                                                    |
|       | Observational Data     |                                                                                                                       |
...
|       |                        |                                                                                                                       |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
| 12/12 | Introduction to        | - RAGLM – Chapter 15: Mediation & Path Analysis                                                                       |
|       | Mediation &            |                                                                                                                       |
|       | Path Analysis          | - Aguinis et al. (2017). Improving our understanding of moderation and mediation in strategic management research.    |
|       |                        |                                                                                                                       |
|       |                        | - *anderWeele (2016). Mediation analysis: A practitioner’s guide.*                                                    |
+-------+------------------------+-----------------------------------------------------------------------------------------------------------------------+
