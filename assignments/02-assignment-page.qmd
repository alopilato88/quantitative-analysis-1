...
format: 
  html:
    page-layout: article
---
<h1 class="h1-reading"> Assignment 2: Statistical Inference & Categorical Predictors</h1>
...
<strong>Assignment R Script</strong>: <a href="02-assignment.R" download target="_blank" rel="noopener noreferrer"><strong>Download</strong></a>

<strong>Assignment Data</strong>: <a href="02-assignment-data.csv" download target="_blank" rel="noopener noreferrer"><strong>Download</strong></a>
